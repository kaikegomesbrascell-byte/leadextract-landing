...
files_to_include = [
    ...
    ('lead-extractor-app/INSTALAR_NAVEGADOR.bat', 'INSTALAR_NAVEGADOR.bat'),
...
1. **LeadExtractor.exe** - Software principal de extração de leads (COM LICENÇA INCLUÍDA)
2. **INSTALAR_NAVEGADOR.bat** - Instalador do navegador Chromium (executar apenas uma vez)
3. **BONUS-1-Guia-Anti-Ban-WhatsApp.pdf** - Guia completo para proteger seu WhatsApp
4. **BONUS-2-Scripts-de-Vendas.pdf** - 3 scripts de vendas de alta conversão

## 🚀 Como Usar

### PRIMEIRA VEZ - Instalação do Navegador

**IMPORTANTE:** Antes de usar o Lead Extractor pela primeira vez, você precisa instalar o navegador Chromium.

1. **Descompacte o arquivo ZIP**
2. **Dê duplo clique em INSTALAR_NAVEGADOR.bat**
3. **Aguarde o download terminar** (~150MB, 2-5 minutos)
4. **Pronto!** Agora você pode usar o LeadExtractor.exe

**NOTA:** Esta instalação é feita APENAS UMA VEZ. Depois disso, você pode usar o programa normalmente.

### Executando o Software

1. **Dê duplo clique em LeadExtractor.exe**
2. **Pronto!** A interface gráfica vai abrir

**IMPORTANTE:** Não precisa instalar Python ou dependências. O executável já contém tudo, incluindo a licença!
...
2. **Clique em "Iniciar Extração"**:
   - A licença será validada automaticamente ✅
...
### Bônus 1: Guia Anti-Ban WhatsApp (Valor: R$ 97)
...
### Bônus 2: Scripts de Vendas (Valor: R$ 147)
...
**Solução:**
1. Execute o arquivo INSTALAR_NAVEGADOR.bat
2. Aguarde o download terminar
3. Execute o LeadExtractor.exe novamente
...
**Versão**: 1.0.4 (Correção do Playwright)
**Atualização**: Corrigido erro do navegador Chromium - agora inclui instalador automático
...
print(f'\n📋 Conteúdo:')
print(f'  • LeadExtractor.exe (COM LICENÇA INCLUÍDA)')
print(f'  • INSTALAR_NAVEGADOR.bat (Instalador do Chromium)')
