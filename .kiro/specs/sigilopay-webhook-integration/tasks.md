...
- [x] 1. Criar e modificar schema do banco de dados
  - [x] 1.1 Criar tabela customers
  ...
  - [x] 1.3 Modificar tabela subscriptions
...
- [x] 2. Modificar fluxo de checkout
  - [x] 2.1 Atualizar API de criação de pagamento PIX
...
- [x] 3. Implementar validação HMAC
  - [x] 3.1 Criar módulo de validação HMAC
...
- [x] 4. Implementar webhook handler principal
  - [x] 4.1 Criar estrutura base do webhook handler
  ...
  - [x] 4.2 Adicionar validação de payload
  ...
  - [x] 4.3 Integrar validação HMAC no handler
  ...
  - [x] 4.4 Configurar cliente Supabase com service role
...
- [x] 6. Implementar processamento de evento payment.approved
  - [x] 6.1 Criar handler para payment.approved
  ...
  - [x] 6.2 Implementar ativação de subscription
...
- [x] 7. Implementar processamento de outros eventos
  - [x] 7.1 Criar handler para payment.rejected
    - Buscar payment pelo sigilopay_id = transactionId
  ...
  - [x] 7.2 Criar handler para payment.expired
    - Buscar payment pelo sigilopay_id = transactionId
  ...
  - [x] 7.3 Criar handler para payment.pending
    - Buscar payment pelo sigilopay_id = transactionId
    - Manter payment.status como 'pending' sem alterações
    - Retornar 200 OK
    - _Requirements: 5.3, 5.6_
  
  - [x] 7.4 Implementar roteamento de eventos
...
- [x] 8. Implementar sistema de logs estruturados
  - [x] 8.1 Criar módulo de logging
  ...
  - [x] 8.2 Adicionar logs em pontos críticos
...
- [x] 9. Implementar tratamento de erros
  - [x] 9.1 Adicionar tratamento de erros de banco de dados
...
- [x] 11. Configurar ambiente Vercel
  - [x] 11.1 Configurar variáveis de ambiente no Vercel
  ...
  - [x] 11.2 Configurar função serverless no vercel.json
...
- [x] 12. Criar documentação
  - [x] 12.1 Documentar configuração do webhook no SigiloPay
...
- [x] 14. Final checkpoint - Validação completa do sistema
  - Ensure all tests pass, ask the user if questions arise.
